...
#'
#' @param JEL_models A fitted JEL model object of class \code{JEL}", containing the estimated joint model components.
...
#'
#' @export
confBands.JEL = function(JEL_models, K = 1, alpha = 0.05){

  fit.JEL = JEL_models$fitJEL
  fit.COX = JEL_models$fitCOX
